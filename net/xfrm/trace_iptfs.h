...
TRACE_EVENT(iptfs_ingress_nth_peek,
	    TP_PROTO(struct sk_buff *skb, uint remaining),
...
TRACE_EVENT(iptfs_ingress_nth_add, TP_PROTO(struct sk_buff *skb, uint share_ok),
